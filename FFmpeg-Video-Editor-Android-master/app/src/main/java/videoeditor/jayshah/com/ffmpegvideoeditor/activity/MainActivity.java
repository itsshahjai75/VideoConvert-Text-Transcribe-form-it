...
public class MainActivity extends AppCompatActivity {
  ...
  /*   Remove -r 1 if you want to extract all video frames as images from the specified time duration.*/
    ...
    private void extractAudioVideo() {
        ...
        //String[] veryComplexComand = {"-i",yourRealPath,"-vn","1","-ab","256k",filePath}; //--- ffmpeg -i video.mp4 -vn -ab 256 audio.mp3
        //execFFmpegBinary(veryComplexComand);
            ...
            ffmpeg.execute(command, new ExecuteBinaryResponseHandler() {
                ...
                public void onSuccess(String s) {
                    ...
                    if (choice == 1 || choice == 2 || choice == 5 || choice == 6 || choice == 7) {
                        ...
                        choice = 41;
                        String[] veryComplexCommand = {"-i",filePath,"-ac","1",filePath};
                        execFFmpegBinary(veryComplexCommand);
